  ...
  >
    ...
    <div class="w-full max-w-5xl px-6
      ...
      <div class="relative flex justify-center gap-12">
        ...
        <h1 class="absolute top-16 text-2xl text-slate-400 font-bold" >{{ weather.value.condition }}</h1>
        <h1 class="absolute font-semibold md:text-8xl text-6xl bottom-5 opacity-70 " >{{ weather.value.temp }}°C</h1>
